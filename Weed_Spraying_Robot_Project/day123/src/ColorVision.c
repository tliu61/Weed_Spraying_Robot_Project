...
volatile float pink_object_x = 0.0;
volatile float pink_object_y = 0.0;
volatile int pink_numpels = 0;
...
//            }
        ...
        if (new_coordata == 0) {
            if (final_object_stats[largest_object].num_pixels_in_object > 1) {
                ...
                if (blueflag ==1) { //acquiring blue weed data
                    blue_object_x = cbar - IMAGE_COLUMNS/2;
                    blue_object_y = rbar - IMAGE_ROWS/2;
                    blue_numpels = final_object_stats[largest_object].num_pixels_in_object;
                    blueflag = 0;
                }
                else { //acquiring pink weed data
                    pink_object_x = cbar - IMAGE_COLUMNS/2;
                    pink_object_y = rbar - IMAGE_ROWS/2;
                    pink_numpels = final_object_stats[largest_object].num_pixels_in_object;
                    blueflag = 1;
                }
